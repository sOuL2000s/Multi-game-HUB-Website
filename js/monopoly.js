document.addEventListener('DOMContentLoaded', () => {
    ...
    window.handleMonopolyServerMessage = function(message) {
        ...
        if (message.type === 'player_assigned') {
            ...
            updateGameStatus(`Monopoly game state updated. It's ${message.gameState.currentPlayerColor.toUpperCase()}'s turn.`);
            console.log("Monopoly Game State Update:", message.gameState);
            // Here, for a real game, you would parse message.gameState and update the Monopoly board,
            // player money, properties, etc.
